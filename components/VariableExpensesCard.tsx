...
import type { VariableExpense } from '@/lib/types'
import { CATEGORIES, ACCOUNTS } from '@/lib/constants'
import { fmt, badgeClass, defaultDateForMonth } from '@/lib/utils'
import { addVariableExpense, deleteVariableExpense } from '@/lib/supabase'
...
export default function VariableExpensesCard({ year, month, expenses, onUpdate }: Props) {
